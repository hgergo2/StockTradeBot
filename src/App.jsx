...
const symbolList = [
    ...
    {label: 'AMD', symbol: 'AMD', id: 4},
    {label: 'INTC', symbol: 'INTC', id: 5},
    {label: 'AMC (szar)', symbol: 'AMC', id: 6},
    {label: 'SHOP', symbol: 'SHOP', id: 7},
    {label: 'ENVX', symbol: 'ENVX', id: 8},
    {label: 'GOOG', symbol: 'GOOG', id: 9},
];

const strategyList = [
    {label: '200 ema', id: 1, strategy: '200ema_strategy'},
    {label: 'random', id: 2, strategy: 'random_strategy'},
    {label: 'support n resistance', id: 3, strategy: 'support_and_resistance'},
    {label: 'macd bollinger', id: 4, strategy: 'macd_bollinger'}
];
                ...
                <Container maxWidth="100vh">
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid xs={2}>
                            ...
                            getOptionDisabled={(option) => option['symbol'] === 'AMC'}
    ...
    if(position != null && position.length > 0){
        for (let i = 0; i < position.length; i++){
            ...
            var row_json = {id: position[i]['_id'],
                        ...
                        //sell_date: dayjs(position[i]['sell_date']).format('YYYY/MM/DD HH:mm:ss'),
