...
all_symbols = ['NVDA', 'TSLA', 'TQQQ', 'AMD', 'INTC', 'SHOP', 'ENVX', 'GOOG']
...
lsh.add_strategy(all_symbols, 'support_and_resistance', start_data, start_data_30m, start_data_60m)
lsh.add_strategy(all_symbols, 'macd_bollinger', start_data, start_data_30m, start_data_60m)
...
while True:
    ...
    #if run_time > 7:
    print(f'Strategies ran in {run_time}, response time: {response_end - start}')
